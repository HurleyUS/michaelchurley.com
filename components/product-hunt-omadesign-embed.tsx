...
export default function ProductHuntOmadesignEmbed() {
  ...
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row items-center justify-center gap-md px-md w-full max-w-[1170px] mx-auto">
        ...
        <div className="flex flex-wrap items-center justify-center gap-md">
          {/* Product rating — primary reviews/engagement badge */}
          <a
