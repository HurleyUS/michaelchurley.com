...
An owner can manage files, uploads, review, the team, archiving and publishing. An editor can download source and assets, upload, comment, reply and resolve threads. A reviewer sees flat exports, pins, rectangular annotations, comments and replies, and can resolve their own threads. Pins scale with the image, including on a phone. The desktop **Review cloud annotations…** window loads the same versioned exports and threads.
